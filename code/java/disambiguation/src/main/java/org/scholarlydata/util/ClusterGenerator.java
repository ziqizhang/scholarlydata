...
public class ClusterGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Collection<Set<String>> clusters=gen.createCluster(args[0], Integer.valueOf(args[1]), Integer.valueOf(args[2]));
        System.out.println("end");
    }

    public Collection<Set<String>> createCluster(String csvFile, int colId1, int colId2) throws IOException {
