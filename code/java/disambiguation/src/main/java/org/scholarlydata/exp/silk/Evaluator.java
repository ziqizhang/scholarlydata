...
public class Evaluator {
    ...
    protected List<String> readPredictionsFormatA(String inFile) throws IOException {
        List<String> lines = FileUtils.readLines(new File(inFile), Charset.forName("utf8"));
        List<String> res = new ArrayList<>();
    ...
    protected void evaluateFormatA() throws IOException {
        String groundtruthTestDataFile="/home/zqz/Work/scholarlydata/data/limes_experiment/org_3_testing_1quarter.csv";
        String predictionFilePos="/home/zqz/Work/scholarlydata/data/silk_experiment/org_marked/output_org3.csv";
        String predictionFileNeg="/home/zqz/Work/scholarlydata/data/silk_experiment/org_marked/output_org_neg3.csv";

        //String groundtruthTestDataFile="/home/zqz/Work/scholarlydata/data/limes_experiment/per_4_testing_1quarter.csv";
        //String predictionFile="/home/zqz/Work/scholarlydata/data/silk_experiment/output_per_4_prediction.nt";
        String outCSV="/home/zqz/Work/scholarlydata/data/silk_experiment/summary_formatA.csv";
        CSVPrinter p = new CSVPrinter(new FileWriter(outCSV), CSVFormat.DEFAULT);
        ...
        for(double threshold=1.0; threshold>0.0; threshold=threshold-0.1) {
            ...
            List<String> truthNeg =
                    readGroundTruth(groundtruthTestDataFile,
                            1, 2, 3, false);
            List<String> predPos =
                    readPredictionsFormatA(predictionFilePos);
            List<String> predNeg =
                    readPredictionsFormatA(predictionFileNeg);

            List<Double> scores = calculate(predPos, predNeg, truthPos, truthNeg);
            scores.add(0,threshold);
            p.printRecord(scores);
        }
        p.close();
